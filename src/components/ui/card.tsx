...
>(({ className, ...props }, ref) => (
  <div
    ...
    className={cn(
      ...
      "relative rounded-2xl bg-card text-card-foreground transition-shadow overflow-hidden bg-clip-padding",
      ...
      // Subtle outline for separation without visible seams
